...
async def analyze():
    ...
    # Retourner les résultats, incluant l’URL de l’image avec le nom attendu
    return {
        "artist": artist,
        "styles": styles,
        "lookalike_artists": similar_artist_names,
...
if __name__ == "__main__":
    port = int(os.getenv("PORT", 5000))  # Utiliser le port dynamique de Railway
